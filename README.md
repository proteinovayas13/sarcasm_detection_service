...
- По стандарту делю датасет на отложенную и обучающую в соотношении `0.8/0.2`.
- В языковых моделях использую всю выборку и проверяю уже на тестовой при валидации в трейнере.
